...
{
// 1. Herencia: Tecnico y Solicitante son tipos especializados de
Usuario.
Tecnico objTecnicoSoftware = new Tecnico("T01", "Ana Lopez",
"ana@empresa.com", "Software", 2);
Tecnico objTecnicoHardware = new Tecnico("T02", "Carlos Mendez",
"carlos@empresa.com", "Hardware", 2);
Tecnico objTecnicoGeneral = new Tecnico("T03", "Maria Perez",
"maria@empresa.com", "General", 3);
Solicitante objSolicitanteContabilidad = new Solicitante("S01", "Luis
Ramirez", "luis@empresa.com", "Contabilidad", "1201");
Solicitante objSolicitanteVentas = new Solicitante("S02", "Karla
Gomez", "karla@empresa.com", "Ventas", "1305");
// 2. Polimorfismo: una lista de Usuario puede contener tecnicos y
solicitantes.
...
// 3. Gestion centralizada: el gestor administra tecnicos, solicitantes
y tickets.
...
// 4. Flujo del ticket: define el ciclo Abierto -> Asignado -> Resuelto
-> Cerrado.
...
Console.WriteLine("\n========================================================");
Console.WriteLine(" SISTEMA DE TICKETS DE SOPORTE TECNICO
CORPORATIVO");
Console.WriteLine("========================================================");
Console.ResetColor();
...
Console.WriteLine("Opcion no valida. Ingrese un numero
del 1 al 9.");
Console.ResetColor();
break;
}
...
{
Console.ForegroundColor = ConsoleColor.Red;
Console.WriteLine("Error controlado por try/catch: " +
ex.Message);
Console.ResetColor();
}
}
...
/// <summary>
/// Demuestra polimorfismo: cada objeto ejecuta su propia version de
mostrarInformacion().
/// </summary>
...
{objGestor.lstSolicitantes[i].strNombre} -
{objGestor.lstSolicitantes[i].strDepartamento}");
}
...
{
throw new ArgumentOutOfRangeException("Solicitante", "Seleccion
fuera de rango.");
}
...
Ticket objTicket = objGestor.crearTicket(strTitulo, strDescripcion,
strCategoria, strPrioridad, objGestor.lstSolicitantes[intIndice]);
...
static void resolverTicket(GestorTickets objGestor, FlujoTicket
objFlujoTicket)
{
Ticket objTicket = solicitarTicket(objGestor);
if (!objFlujoTicket.puedeCambiarEstado(objTicket.strEstado,
"Resuelto"))
{
throw new InvalidOperationException("El flujo no permite resolver
el ticket desde el estado actual.");
}
...
static void cerrarTicket(GestorTickets objGestor, FlujoTicket
objFlujoTicket)
{
Ticket objTicket = solicitarTicket(objGestor);
if (!objFlujoTicket.puedeCambiarEstado(objTicket.strEstado, "Cerrado"))
{
throw new InvalidOperationException("El flujo no permite cerrar el
ticket desde el estado actual.");
}
objTicket.cerrar();
